...
6. Na página **de Implantação,** determine se pretende ser implantado agora ou mais tarde. Se optar por implementar mais tarde, poderá encontrar a aplicação em > **Aplicações**de Gestão de > **Aplicações**de Biblioteca de **Software.**  
...
10. Pode implementar ou editar a aplicação a partir de aplicações de**gestão** > de**aplicações**de**visão geral** > da Biblioteca > de **Software.**    
...
2. Clique em **Ligar**, e, *em&lt;seguida,&gt;digitar root\sms\site_ siteCode*.
...
10. Na consola de Gestor de Configuração, vá ao Gabinete de Visão**Geral** > da **Biblioteca** > de Software**365** > Client Management**Office 365 Atualizações.**
...
## <a name="change-the-update-channel-after-you-enable-office-365-clients-to-receive-updates-from-configuration-manager"></a><a name="bkmk_channel"></a>Altere o canal de atualização depois de permitir que os clientes do Office 365 recebam atualizações do Gestor de Configuração
