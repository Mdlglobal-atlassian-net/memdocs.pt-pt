---
title: Desempenho do SQL
titleSuffix: Configuration Manager
description: Use este diagrama para iniciar a resolução de problemas do desempenho do SQL para o Gestor de Configuração
ms.date: 08/09/2019
...
ms.locfileid: "81714627"
---
# <a name="sql-performance"></a>Desempenho do SQL
...
Utilize o seguinte diagrama para iniciar a resolução de problemas do desempenho do SQL que pode impactar o estado de replicação:

![Diagrama para resolver o desempenho da SQL](media/sql-performance.png)
...
### <a name="make-sure-sql-change-tracking-table-is-cleaned-up"></a>Certifique-se de que a tabela de rastreio de alterações SQL está limpa
...
### <a name="change-current-sessions-that-handle-sql-service-broker-messages-are-blocked"></a>Altere as sessões atuais que lidam com mensagens de corretor de serviço SQL estão bloqueadas
...
### <a name="check-sessions-asking-too-much-memory"></a>Verifique as sessões pedindo muita memória
...
### <a name="check-sessions-taking-too-many-locks"></a>Verifique as sessões tomando muitas fechaduras
