---
title: Monitorize clientes com Windows Analytics
titleSuffix: Configuration Manager
description: O Windows Analytics é um conjunto de soluções que lhe permitem obter informações valiosas sobre o estado atual do seu ambiente.
ms.date: 01/31/2020
...
Se o site do Gestor de Configuração tiver uma ligação com a Prontidão de Upgrade, tem de o remover e reconfigurar os clientes. Para mais informações, consulte [A ligação de preparação de atualização .](upgrade-readiness.md#bkmk_remove)
