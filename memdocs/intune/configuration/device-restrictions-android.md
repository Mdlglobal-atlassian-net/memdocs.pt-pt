...
- Comprimento mínimo da **palavra-passe**: Introduza o número mínimo de caracteres necessários, de 4 a 16. Por exemplo, `6` introduza para exigir pelo menos seis números ou caracteres no comprimento da palavra-passe.
...
- **Lista de aplicações**: **Adicione** a sua aplicação
  ...
  - URL da loja de **aplicações**: Introduza o URL da Google Play Store da aplicação que deseja. Por exemplo, para adicionar o aplicativo Microsoft `https://play.google.com/store/apps/details?id=com.microsoft.rdc.android`Remote Desktop para Android, introduza .
  ...
  - **Editor** (opcional): Insira o editor `Microsoft`da app, como .

Também pode **importar** um ficheiro CSV com detalhes sobre a aplicação, incluindo o URL. Utilize o> de url de *aplicação* <, <nome de *aplicação*>, <editor de *aplicações*> formato. Ou, **Exportar** uma lista existente que inclui a lista de aplicações restritas no mesmo formato.
