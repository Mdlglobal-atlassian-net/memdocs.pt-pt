...
3. Em **'Criar perfil',** introduza *o TestProfile* para **nome** e *teste ADE para dispositivos iOS/iPadOS* para **descrição**. Os utilizadores não verão estes detalhes.
