...
> [!NOTE]
> As informações neste tópico aplicam-se apenas a computadores Windows que está a gerir como PCs através do cliente de software do Intune. Se pretender gerir as atualizações para Computadores Windows inscritos como dispositivos móveis, consulte ['Gerir as atualizações de software' no Intune](../protect/windows-update-for-business-configure.md).
