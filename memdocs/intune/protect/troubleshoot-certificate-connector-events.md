---
title: Problemas de resolução do conector de certificados Microsoft Intune e iDs de eventos / Microsoft Docs
titleSuffix: Microsoft Intune
description: Problemas saca o conector de certificado Sinton da Microsoft através da revisão de IDs e descrições do Evento e reveja os códigos de diagnóstico para o serviço de conector Intune.
keywords: ''
author: brenduns
ms.author: brenduns
manager: dougeby
...
> [!TIP]  
> Para resolver problemas e verificar a configuração do Conector Intune, consulte [as amostras](https://aka.ms/intuneconnectorverificationscript)de script da Autoridade de Certificado .
