...
A imagem de marca certa pode aumentar a confiança do utilizador no Portal da Empresa apresentando um forte sentido da marca da sua empresa. Aqui estão algumas sugestões que poderá considerar para comprar, escolher e otimizar a imagem do Portal da Empresa. 
...
- Evite utilizar uma imagem de stock genérica. A imagem deve refletir a marca da sua empresa e sentir-se familiar aos utilizadores. Se não tiver um, é melhor não usar um do que usar um genérico que não tem significado para o seu utilizador. 
