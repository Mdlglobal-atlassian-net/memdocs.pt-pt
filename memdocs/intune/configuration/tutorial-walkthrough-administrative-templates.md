...
Intune, as políticas são aplicadas aos utilizadores e grupos que cria. Não há uma hierarquia. Por exemplo:
...
1. No centro de administração do Endpoint Manager > Atualização de Perfis de **Configuração**  >  **Refresh**.
