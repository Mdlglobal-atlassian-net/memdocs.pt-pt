...
1. Na consola de [administração Microsoft Intune,](https://manage.microsoft.com/)escolha **Grupos** &gt; **Todos os Dispositivos** (ou outro grupo que contenha o PC que pretende ligar a um utilizador).
...
3. Efetue uma das seguintes ações:
   ...
   - Para remover a ligação ao utilizador atual, se houver um, escolha <strong>remover a ligação **&gt;** OK</strong>.
