...
- **Digitale ficheiros de arquivo:**  
  CSP: [Defender/PermitirArchiveScanning](https://go.microsoft.com/fwlink/?linkid=2114047)
...
- Pedido automático de zona de **internet do Internet Do Internet Explorer para downloads** de ficheiros > O valor predefinido é agora **desativado**. Na pré-visualização, esta definição foi definida para Ativar.
