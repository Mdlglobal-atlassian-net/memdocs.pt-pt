...
- As importantes atualizações de serviço também são anunciadas no [Microsoft 365 administrador center](https://admin.microsoft.com/) Message Center. Se instalar o complemento [aplicação móvel Office 365 Admin](https://support.office.com/article/Office-365-Admin-Mobile-App-e16f6421-2a1a-4142-bf9d-9846600a060a), pode receber notificações no seu dispositivo móvel. Saiba mais sobre como trabalhar com o [Centro de Mensagens do Office 365](https://support.office.com/client/results?Shownav=true&ns=O365ENTADMIN&version=15&ver=15&HelpID=O365E_MCManageUpdates).
  ...
  - As mensagens no Centro de Mensagens do Office 365 são direcionadas. Isto significa que se a sua empresa não tiver uma oferta intune para a EDU, não lhe enviaremos uma mensagem sobre intune para a EDU.

  - As mensagens expiram. Por exemplo, a notificação de que o seu serviço foi atualizado com um link para a página What's New provavelmente expirará antes da próxima notificação de atualização de serviço. Caso contrário, teria um grande atraso de postos que podem já não ser relevantes.
  ...
  - Sob as preferências do centro de mensagens Edit, eventualmente teremos um alternância para **Intune** para que possa ver as mensagens postadas numa subscrição Intune. Caso veja a Gestão de Dispositivos Móveis do Office 365, trata-se de um serviço diferente, não do Intune.

- Também utilizamos dois blogues para partilhar a mensagem do EMS e as melhores práticas de suporte do Intune:

  - [Enterprise Mobility + Blog de segurança](https://blogs.technet.microsoft.com/enterprisemobility/)

  - [Blog de apoio intune](https://blogs.technet.microsoft.com/intunesupport/)
...
- Alterações à experiência do utilizador final que poderá partilhar com a sua equipa de suporte técnico ou os seus utilizadores finais. Fornecemos normalmente 7 a 30 dias de aviso prévio dessas alterações e documentamo-las no [What's New in Intune App UI](whats-new-app-ui.md). Para algo como uma correção de erros ortográficos, normalmente não vamos chamar em documentação. Mas uma mudança na experiência de inscrição de utilizadores finais é suficientemente significativa na UI para que ambos publiquemos uma mensagem aos clientes no Centro de Mensagens do Office 365 e liguem-se ao What's New na Intune App UI para que seja notificado do que está a mudar e tenha tempo para avaliar e atualizar a sua orientação de utilizador final antes das alterações que estão a ser lançadas na produção.
...
- Para a maioria das depreciações, preferimos fornecer avisos de 90 dias dessa depreciação. Por exemplo, se não vamos mais apoiar uma versão específica do IE, o nosso objetivo é fornecer um pré-aviso de 90 dias. No entanto, as depreciações complicam-se quando é outra empresa a anunciar a depreciação. Por exemplo, uma empresa de browsers forneceu um aviso de que deixaria de suportar o Silverlight na sua compilação mais recente, pelo que informámos os clientes de que íamos deixar de suportar esse browser, porém, a nossa notificação foi para os clientes num período inferior aos 90 dias.

- Em caso de extinção do serviço Intune, seria notificado com uma antecedência de 12 meses.

Finalmente, no caso raro de existir qualquer ação pós-incidente necessária para que o seu serviço volte ao normal ou uma grande mudança que consideramos potencialmente disruptiva com base no feedback do cliente, enviaremos um e-mail aos administradores de serviços com base na forma como as suas preferências de comunicação do [Office 365](https://support.office.com/article/Change-your-contact-preferences-for-communications-from-Microsoft-6f70de1b-a64d-4498-bfbd-be8c83a9c0fc) são definidas e se inclui um endereço de e-mail válido (e de preferência trabalho).  
