...
- Na aplicação Portal da Empresa, abane o dispositivo e, quando o alerta de diagnóstico for apresentado, toque em **Enviar Relatório de Diagnóstico**. Se o alerta não aparecer quando abanar o dispositivo, abra o Portal da Empresa **definições**  >  **Company Portal**, e certifique-se de que a opção **Shake Gesture** está aser.
