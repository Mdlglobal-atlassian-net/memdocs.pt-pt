...
description: Para dispositivos móveis que executam o Windows, é necessário atualizar o seu dispositivo.
keywords: ''
author: lenewsad
ms.author: lanewsad
manager: dougeby
...
ms.locfileid: "83880712"
---
# <a name="you-need-to-update-your-windows-device"></a>Necessita de atualizar o seu dispositivo Windows

[!INCLUDE [wit_nextref](includes/end-user-os-update-guidance.md)]

Para dispositivos móveis que executem o Windows, atualize o seu dispositivo navegando para a atualização do telefone **Definição**  >  **phone update**  >  **para obter atualizações**.
