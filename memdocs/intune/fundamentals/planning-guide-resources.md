...
- [Documentação do Microsoft Intune](https://docs.microsoft.com/intune/) – O conjunto completo da documentação do Intune.
...
- [Comunicação](migration-guide-communication-plan.md) do plano - O plano de comunicação é um elemento chave para uma adoção intune. Neste artigo, você pode baixar o Kit de Adoção Intune que inclui modelos de e-mail, um guia de inscrição intune, e links para vídeos instrutivos para ajudá-lo a educar seus utilizadores finais na inscrição.
