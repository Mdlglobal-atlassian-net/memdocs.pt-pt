...
description: Utilize o Descarregue o Assistente de Atualizações de Software para descarregar atualizações de software e distribuí-las para pontos de distribuição para que estejam prontas a ser implementadas para os clientes.
ms.date: 01/23/2017
ms.topic: conceptual
