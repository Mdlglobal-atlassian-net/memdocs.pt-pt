...
|-----------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| É necessária uma senha. | Defina uma palavra-passe. A sua organização exige que introduza uma senha para desbloquear o seu dispositivo. |
...
| A senha deve conter caracteres não alfanuméricos. | Adicione caracteres especiais `&` `!` como, `$` , , , `%` e `#` . A sua organização requer uma mistura de letras, números e caracteres não alfanuméricos para dificultar aos outros adivinhar a senha.|
| A senha expirou. | Deteta uma nova senha. A sua organização exige que altere a sua senha após um certo número de dias. |
...
| A palavra-passe só deve conter números. | Detete uma palavra-passe que contenha apenas números.|
| A palavra-passe só deve conter caracteres alfanuméricos. | Detete uma palavra-passe que contenha uma mistura de números e letras.|
| A palavra-passe deve conter caracteres não alfanuméricos. | Adicione caracteres especiais `&` `!` como, `$` , , , `%` e `#` . A sua organização requer uma mistura de letras, números e caracteres não alfanuméricos para dificultar a adivinhação da palavra-passe por parte dos outros.|
| A senha expirou. | Deteta uma nova senha. A sua organização exige que altere a sua senha após um certo número de dias. |
| A palavra-passe foi utilizada muito recentemente. | Escolha uma palavra-passe que nunca tenha usado antes. A sua organização exige que um certo tempo passe antes de reutilizar uma senha. |
