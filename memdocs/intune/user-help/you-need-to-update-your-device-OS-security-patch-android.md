...
description: Precisa atualizar o sistema operativo do seu dispositivo Android.
keywords: ''
author: lenewsad
ms.author: lanewsad
manager: dougeby
...
Se tiver um dispositivo Samsung, vá a **Definições** > **Sobre telefone**, e verifique se a palavra "Knox" está em algum lugar no ecrã. Se assim for, siga as instruções para o Samsung Knox abaixo.

[!INCLUDE [wit_nextref](includes/end-user-os-update-guidance.md)]

## <a name="for-most-android-devices-non-samsung-knox"></a>Para a maioria dos dispositivos Android (não Samsung Knox)

Vá a **Definições** > **sobre** > **atualizações**de Software . Instale a atualização e o seu dispositivo deverá ficar com a atualização de segurança correta instalada.

## <a name="for-samsung-knox-android-devices"></a>Para dispositivos Android Samsung Knox

Vá a **Definições** > **System updates** > de sistema**Verifique a nova atualização do sistema**. Instale a atualização e o seu dispositivo Samsung Knox deverá ficar com a atualização de segurança correta instalada.
